...
const TASK_BANK_TEMPLATES = {
  ...
  'הנהלה': [
    { title: 'ישיבת בוקר הנהלה', description: 'הערכת מצב וסנכרון משימות יומי' },
    { title: 'מעקב סטטוס ארגוני', description: 'סקירת ביצוע משימות בכלל הצוותים' },
    { title: 'סיכום יום ויעדים למחר', description: 'סיכום הישגים יומי והפצת דגשים' },
...
const App = () => {
  ...
  const handleSeedWorkspaceTasks = async (teamName) => {
    const templates = {
      ...
      'הנהלה': [
        { title: 'ישיבת בוקר הנהלה', description: 'הערכת מצב וסנכרון משימות יומי', timeOfDay: 'morning' },
        { title: 'מעקב סטטוס ארגוני', description: 'סקירת ביצוע משימות בכלל הצוותים', timeOfDay: 'noon' },
        { title: 'סיכום יום ויעדים למחר', description: 'סיכום הישגים יומי והפצת דגשים', timeOfDay: 'evening' }
      ]
    };
                ...
                {isTamar ? (
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    <div style={{ fontSize: '0.85rem', background: 'rgba(255,255,255,0.06)', padding: '0.6rem', borderRadius: '8px', opacity: 0.8 }}>
                      שייך עובדים מתוך <strong>צוות {sergeantTeam}</strong> לתורנויות היומיות.
                    </div>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'right' }}>
                  ...
                  <tbody>
                    ...
                    {filteredUsers.length === 0 && (
                      <tr>
                        <td colSpan="3" style={{ textAlign: 'center', padding: '2rem', opacity: 0.6 }}>לא נמצאו עובדים.</td>
                      </tr>
                    )}
                  </tbody>
                </table>
            ...
            >
              ...
              {displayWorkers.length === 0 && (
                <div className="team-section" style={{ textAlign: 'center', padding: '2rem 0' }}>
                  <p style={{ opacity: 0.6 }}>אין עובדים משוייכים לצוות זה כרגע</p>
                </div>
              )}
      ...
      {isQrModalOpen && (
        <div className="registration-overlay" style={{position:'fixed', inset:0, background:'rgba(0,0,0,0.6)', zIndex:2000, display:'flex', alignItems:'center', justifyContent:'center'}} onClick={() => setIsQrModalOpen(false)}>
           <div className="glass-card" style={{width:'90%', maxWidth:'400px', textAlign:'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem', padding: '2rem'}} onClick={e => e.stopPropagation()}>
              ...
              <p style={{ opacity: 0.8, fontSize: '0.9rem', margin: '0' }}>העובדים יכולים לסרוק את הברקוד כדי להגיע ישירות לעמוד הדיווח העצמי:</p>
